  ...
  static init() {
    gameStories = {
      StoryTitles.introArc.name: [
        MsgFormat(
            "Welcome to a journey where small actions make a big impact! Every choice you make in this game will help protect our planet.Your efforts will create a brighter, greener future. Remember, every step counts—let’s start building a sustainable world together!",
